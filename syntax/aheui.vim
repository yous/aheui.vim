...
syn match aheuiPop            '[마-밓]'
      \ contains=aheuiPopNumber,aheuiPopCharacter
syn match aheuiPopNumber      '[망맹먕먱멍멩명몡몽뫙뫵묑묭뭉뭥뮁뮝뮹믕믱밍]'
      \ containedin=aheuiPop
syn match aheuiPopCharacter   '[맣맿먛먷멓멯몋몧뫃뫟뫻묗묳뭏뭫뮇뮣뮿믛믷밓]'
      \ containedin=aheuiPop
syn match aheuiPush           '[바-빟]'
      \ contains=aheuiPushNumber,aheuiPushCharacter
syn match aheuiPushNumber     '[방뱅뱡뱽벙벵병볭봉봥뵁뵝뵹붕붱뷍뷩븅븡븽빙]'
      \ containedin=aheuiPush
syn match aheuiPushCharacter  '[밯뱋뱧벃벟벻볗볳봏봫뵇뵣뱋붛붷뷓뷯븋븧빃빟]'
      \ containedin=aheuiPush
